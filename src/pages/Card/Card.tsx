      ...
      {Destination.map((item) => {
        ...
        return (
          <div key={title} className="relative h-auto w-auto overflow-hidden">
            ...
            {star ? (
              <button className="absolute backdrop-blur-sm bg-white/30 top-2 right-2 backdrop-blur-none rounded-3xl shadow-lg flex items-center justify-between gap-3 border-none text-theme-pink whitespace-nowrap px-7 py-3 hover:shadow-lg hover:shadow-theme-blue/50 hover:text-white hover:bg-theme-blue">
            ...
            <h2 className="text-lg font-bold m-4 text-3xl">{title}</h2>
            <p className="text-gray-600 mb-2 mx-4">{description}</p>
            <div className="flex justify-between  backdrop-blur-md bg-gray-600/5 items-center rounded-b-2xl mb-2 p-1">
